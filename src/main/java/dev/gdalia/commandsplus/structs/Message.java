...
public enum Message {
	...
	PLAYER_NOT_BAN(Main.getLanguageConfig().getString("PLAYER_NOT_BAN")),
	...
	PLAYER_UNMUTE(Main.getLanguageConfig().getString("PLAYER_UNMUTE")),
	TARGET_UNMUTE(Main.getLanguageConfig().getString("TARGET_UNMUTE")),
	PLAYER_UNBAN(Main.getLanguageConfig().getString("PLAYER_UNBAN")),
	...
	PLAYER_NOT_MUTE(Main.getLanguageConfig().getString("PLAYER_NOT_MUTE")),
